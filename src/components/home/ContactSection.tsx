  ...
  return (
    <section className="container mx-auto px-4">
      ...
      >
        ...
        <div
          className="relative lg:absolute lg:left-10 xl:left-[-50px] 
        lg:top-1/2 lg:-translate-y-1/2 xl:-translate-y-1/2 w-[280px] 
        ...
        <div
          className="w-full xl:w-1/2 relative z-10 flex flex-col items-center 
                    lg:items-start text-center lg:text-start ps-0 lg:ps-10 
                    xl:ps-[140px] mb-5 xl:mb-0"
        >
          ...
          <p className="text-[#A6A6A6] mb-8 leading-relaxed text-sm md:text-base xl:text-sm max-w-[424px] xl:ml-auto">
            {t("description")}
          </p>
