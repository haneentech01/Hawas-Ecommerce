...
export default function SmallPromoCard({
  titleKey,
  subtitleKey,
  image,
  bgColor,
  ...
  return (
    ...
    >
      <div className="relative flex flex-col h-full w-full p-4 md:p-6 lg:p-8">
        ...
        {/* Image */}
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-[100%] h-[85%] pointer-events-none z-10">
          <Image
            src={image}
            alt=""
            fill
